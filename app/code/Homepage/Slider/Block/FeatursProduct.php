 ...
 * @SuppressWarnings(PHPMD.CouplingBetweenObjects))
 */
class FeatursProduct extends \Magento\Catalog\Block\Product\AbstractProduct
{
    ...
    /**
     * Give FeaturesPRoduct Collection
     *
     * @return void
     */
    public function featuresProducts()
    {
        ...
        $collection->addAttributeToSelect('*');
        $collection->addAttributeToFilter('featurecode', ['notnull' => true]);
        $collection->addAttributeToFilter('featurecode', ['neq' => '']);
